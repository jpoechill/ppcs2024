...
export default function Header() {
  ...
  return (
    <div>
      <div className="fixed bg-white flex justify-center w-full z-[10] top-0 py-2 border-b lg:pt-6 lg:p-4 px-10 ">
      ...
      {
        showMenu &&
        <div className="fixed pt-[100px] z-[0] w-full px-10 pb-5 shadow-xl bg-[#fbfefe]">
          ...
          <div>
            <Link href="/quote" className="flex mt-4">
